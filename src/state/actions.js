...
export const toggleTodo = async (dispatch, todo) => {
    try {
...
//middleware to add a todo then dispatch an action to update the state
export const addTodo = async (dispatch, title) => {
